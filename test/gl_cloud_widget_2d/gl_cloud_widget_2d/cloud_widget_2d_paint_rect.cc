...
void CloudWidget2DPaintRect::paint(QPainter* painter, QPaintEvent* /*event*/) {
...
void CloudWidget2DPaintRect::process_widget_resize(QSize size) {
  QRect rect(QPoint(0, 0), size);
  update_phy_points(rect);
}

void CloudWidget2DPaintRect::update_phy_points(const QRect& rect) {
